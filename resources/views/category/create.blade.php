...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-11">
                <form class="form-horizontal text-sm-center" action="{{ route('categories.store') }}" method="post">
                    @csrf
                    <div class="form-group row mb-3 justify-content-center">
                        <label class="col-3 col-form-label">Tên loại</label>
                        <div class="col-7">
                            <input type="text" class="form-control" name="name" placeholder="Tên loại sản phẩm" value="{{ old('name') }}">
                            @if ($errors->has('name'))
