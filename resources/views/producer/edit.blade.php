...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal text-sm-center" action="{{ route('producers.update', $each) }}"
                          method="post">
                        @csrf
                        @method ('PUT')
                        ...
                        <div class="form-group row mb-3 justify-content-center">
                            ...
                            <div class="col-7">
                                <input type="text" class="form-control" name="phone"
                                       placeholder="Số điện thoại nhà cung cấp" value="{{ $each->phone }}">
                                @if ($errors->has('phone'))
                        ...
                        <div class="form-group row mb-3 justify-content-center">
                            ...
                            <div class="col-7">
                                <input type="text" class="form-control" name="address"
                                       placeholder="Địa chỉ nhà cung cấp" value="{{ $each->address }}">
